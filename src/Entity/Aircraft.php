...
class Aircraft {
	...
	#[ORM\OneToOne( inversedBy: 'aircraft', cascade: [ 'persist', 'remove' ] )]
	private ?AircraftPosition $last_position = null;
	...
	public function getLastPosition(): ?AircraftPosition {
		return $this->last_position;
	}

	public function setLastPosition( ?AircraftPosition $last_position ): self {
